...
TEST_CASE("dfs_bve_unit_tests", "[dfs]") {
  ...
  scalar_view_type rel_vort_error("relative_vorticity_gmls_error",
                                  dfs_bve.grid_size());
  ErrNorms gmls_err(rel_vort_error, rel_vort_grid_gmls.view,
                    dfs_bve.rel_vort_grid.view, dfs_bve.grid_area);
  ...
  vtk_grid.add_scalar_point_data(rel_vort_grid_gmls.view,
                                 "relative_vorticity_gmls");
  vtk_grid.add_scalar_point_data(rel_vort_error,
                                 "relative_vorticity_gmls_error");
