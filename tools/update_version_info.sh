...
major_version=`grep '(LPM_MAJOR_VERSION' $1/CMakeLists.txt | sed -e 's/set (//' -e 's/)$//' -e 's/LPM_MAJOR_VERSION //'`
minor_version=`grep '(LPM_MINOR_VERSION' $1/CMakeLists.txt | sed -e 's/set (//' -e 's/)$//' -e 's/LPM_MINOR_VERSION //'`
...
cat > $cpp_file <<- END
// This file is automatically generated by the update_version_info.sh.
// DO NOT EDIT!
...
echo "const char* _version = \"$major_version.$minor_version\";" >> $cpp_file
