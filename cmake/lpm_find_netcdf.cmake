...
if (LPM_ENABLE_NETCDF)
  ...
  #
  # Let's agree on a consistent case: NetCDF (not netcdf or netCDF)
  #
  if (netCDF_FOUND)
    ...
    if (TARGET NetCDF::NetCDF)
      message(STATUS "found target: NetCDF::NetCDF")
    else()
      ...
      elseif (TARGET "netcdf")
        message(STATUS "found target: netcdf")
        set_target_properties(NetCDF::NetCDF PROPERTIES
          INTERFACE_LINK_LIBRARIES "netcdf")
        else()
          message(STATUS "target not found: netCDF::netcdf; linking to ${netCDF_LIBRARIES}")
          set_target_properties(NetCDF::NetCDF PROPERTIES
            INTERFACE_LINK_LIBRARIES ${netCDF_LIBRARIES})
        endif()
    endif()
    set(LPM_USE_NETCDF TRUE CACHE BOOL "")
    list(APPEND LPM_EXT_INCLUDE_DIRS ${NetCDF_INCLUDE_DIRS})
