...
Option::Option(const std::string& name, const std::string& sf,
               const std::string& lf, const std::string& desc,
...
bool operator<(const Option& lhs, const Option& rhs) noexcept {
  return std::tie(lhs.name, lhs.short_flag, lhs.long_flag, lhs.description,
                  lhs.value) < std::tie(rhs.name, rhs.short_flag, rhs.long_flag,
                                        rhs.description, rhs.value);
}

bool operator==(const Option& lhs, const Option& rhs) noexcept {
  return std::tie(lhs.name, lhs.short_flag, lhs.long_flag, lhs.description,
                  lhs.value) == std::tie(rhs.name, rhs.short_flag,
                                         rhs.long_flag, rhs.description,
                                         rhs.value);
}
...
Input::Input(const std::string& md)
    : meta_description(md), help_and_exit(false) {}

Input::Input(const std::string& md, const std::vector<Option> opts)
    : meta_description(md), help_and_exit(false) {
