...
vtkSmartPointer<vtkPolyData> VtkInterface<Geo, FaceKind>::toVtkPolyData(
    const Faces<FaceKind, Geo>& faces, const Edges& edges,
    const Vertices<Coords<Geo>>& verts,
    const vtkSmartPointer<vtkPointData>& ptdata,
...
template <typename Geo, typename FaceKind>
void VtkInterface<Geo, FaceKind>::writePolyData(
    const std::string& fname, const vtkSmartPointer<vtkPolyData> pd) {
...
template <typename Geo, typename FaceKind>
void VtkInterface<Geo, FaceKind>::addScalarToPointData(
    vtkSmartPointer<vtkPointData>& pd,
    const typename scalar_view_type::HostMirror sf, const std::string& name,
    const Index nverts) const {
...
template <typename Geo, typename FaceKind>
void VtkInterface<Geo, FaceKind>::addVectorToPointData(
    vtkSmartPointer<vtkPointData>& pd,
...
template <typename Geo, typename FaceKind>
void VtkInterface<Geo, FaceKind>::addScalarToCellData(
...
template <typename Geo, typename FaceKind>
void VtkInterface<Geo, FaceKind>::addVectorToCellData(
    vtkSmartPointer<vtkCellData>& cd,
    const typename ko::View<Real * [Geo::ndim], Dev>::HostMirror vf,
