...
#define LPM_ASSERT_MSG(condition, msg)  IMPL_THROW(condition, msg, std::runtime_error)
#define LPM_KERNEL_ASSERT(condition) IMPL_KERNEL_THROW(condition, "")
#define LPM_KERNEL_ASSERT_MSG(condition, msg) IMPL_KERNEL_THROW(condition, msg)
#else
...
#define LPM_REQUIRE_MSG(condition, msg) IMPL_THROW(condition, msg, std::runtime_error)
