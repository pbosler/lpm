...
/** @brief Solves Poisson equation for the stream function (but not velocity) at
 passive particlse.
 @device
 @par Parallel pattern:
 1 thread team per target site performs two reductions -- 1 for stream function
...
/** @brief Solves Poisson equation for velocity (but not the stream function) at
 passive particlse.
 @device
 @par Parallel pattern:
 1 thread team per target site performs two reductions -- 1 for stream function
...
/** @brief Solves the BVE for both stream function and velocity at active
particles.
