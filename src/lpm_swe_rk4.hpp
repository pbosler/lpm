...
class SWERK4 {
 ...
 private:
  ...
  void advance_timestep(crd_view& vx, scalar_view_type& vzeta,
                        scalar_view_type& vsigma, scalar_view_type& vh,
                        vec_view& vvel, crd_view& fx, scalar_view_type& fzeta,
                        scalar_view_type& fsigma, scalar_view_type& fh,
                        vec_view& fvel, scalar_view_type& farea,
