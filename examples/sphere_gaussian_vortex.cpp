  ...
  Kokkos::initialize(argc, argv);
  {
    ...
    */
    ...
    if (amr) {
      ...
      Kokkos::deep_copy(sphere->ref_crds_passive.view,
                        sphere->mesh.vertices.lag_crds.view);
      Kokkos::deep_copy(sphere->ref_crds_active.view,
...
void init_input(user::Input& input) {
  ...
  user::Option remesh_interpolation_order(
      ...
      "polynomial order for gmls-based remesh interpolation", 6);
