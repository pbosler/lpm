...
int main (int argc, char* argv[]) {
  ...
  Kokkos::initialize(argc, argv);
  {
    user::Input input("bve_gauss_vort");
    {
      ...
      user::Option output_file_root_option("output_file_root", "-o", "--output-file-root", "output file root", std::string("sphere_gauss_vort"));
    ...
    */
    ...
    const std::vector<std::string> tracer_names = {"ftle", "initial_latitude"};
